        ...
        <div className="services__content">
            ...
            <div className={toggleState === 2 ? "services__modal active-modal" : "services__modal"}>
                <div className="services__modal-content">
                    ...
                    <p className="services__modal-description">Vou atuar melhorando o layout, interatividad e acessibilidade do seu conteúdo na Web!</p>

                    <ul className="services__modal-services grid">
                        <li className="services__modal-service">
                            <i className="uil uil-check-circle services__modal-icon"></i>
                            <p className="services__modal-info">
                                Desenvolvimento de Interfaces e interação com o usuário.
                            </p>
                        </li>
                        ...
                        <li className="services__modal-service">
                            <i className="uil uil-check-circle services__modal-icon"></i>
                            <p className="services__modal-info">
                                Acessibilidade e melhoria da experiência dos usuários.
                            </p>
                        </li>
                        ...
                        <li className="services__modal-service">
                            <i className="uil uil-check-circle services__modal-icon"></i>
                            <p className="services__modal-info">
                               Otimização e prototipagem do conteúdo.
                            </p>
                        </li>
                        ...
                        <li className="services__modal-service">
                            <i className="uil uil-check-circle services__modal-icon"></i>
                            <p className="services__modal-info">
                                Melhorar a acessibilidade e usabilidade do seu website.
                            </p>
                        </li>
